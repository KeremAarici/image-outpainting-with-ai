...
class ImageProcessor:
    ...
    @staticmethod
    def create_outpainting_mask(image: Image.Image, padding: dict, blur_radius: int = 6) -> tuple[Image.Image, Image.Image]:
        """
        Expands canvas and creates a strictly bounded mask to prevent inner object distortion.
        """
